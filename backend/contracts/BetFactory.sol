...
contract BetFactory {
    ...
    event BetCreated(address indexed betAddress, string team1, string team2, uint256 matchDate);

    // Função para criar um novo contrato de aposta
    function createBet(string memory _team1, string memory _team2, uint256 _matchDate) public {
        BetContract newBet = new BetContract(_team1, _team2, _matchDate);
